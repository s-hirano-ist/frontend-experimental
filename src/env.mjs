...
export const env = createEnv({
   ...
   */
  client: {
    NEXT_PUBLIC_BACKEND_HOST: z.string().url(),
    NEXT_PUBLIC_GRAPHQL_BACKEND_HOST: z.string().url(),
    NEXT_PUBLIC_SELF_GRAPHQL_HOST: z.string().url(),
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_GRAPHQL_BACKEND_HOST:
      process.env.NEXT_PUBLIC_GRAPHQL_BACKEND_HOST,
    NEXT_PUBLIC_SELF_GRAPHQL_HOST: process.env.NEXT_PUBLIC_SELF_GRAPHQL_HOST,
